		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "The Bake Shop",
									"targetURL": "#comspordertodelivery-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comspordertodelivery-display": {
								"semanticObject": "comspordertodelivery",
								"action": "display",
								"description": "Order to Delivery Process",
								"title": "The Bake Shop",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sp.ordertodelivery",
									"url": sap.ui.require.toUrl("com/sp/ordertodelivery")
								}
							}
						}
					}
